...
- [Rectangle](https://rectangleapp.com): Move and resize windows easily. **(Free)**
  ```
  brew install --cask rectangle
  ```

- [Postman](https://www.postman.com/): Easily make HTTP requests. Useful to test your REST APIs. **(Free for basic features)**
  ```
  brew install --cask rectangle
  ```

- [Maccy](https://maccy.app): A clipboard manager for macOS which does one job - keep your copy history at hand. Period. **(Free)**
  ```
  brew install --cask maccy
  ```

- [Monitor control](https://github.com/MonitorControl/MonitorControl): An awesome tool to control external monitor brightness & volume. **(Free)**
  ```
  brew install --cask monitorcontrol
  ```

- [Xnip](https://www.xnipapp.com): A great snipping tool to annotate the screenshots directly. (**Free**, [Available on the AppStore](https://itunes.apple.com/us/app/xnip/id1221250572?mt=12))
